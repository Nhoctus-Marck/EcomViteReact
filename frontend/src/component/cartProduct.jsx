      ...
      <div className="flex flex-col gap-1 w-full">
        ...
        <div className="flex justify-between ">
          <div className="flex gap-3 items-center">
            <button className="bg-slate-300 py-1 mt-2 rounded hover:bg-slate-400 p-1" onClick={()=>dispatch(increaseQty(id))}>
              <HiOutlinePlus />
            </button>
            <p className="font-semibold p-1">{qty}</p>
            <button
              className="bg-slate-300 py-1 mt-2 rounded hover:bg-slate-400 p-1" onClick={()=>dispatch(decreaseQty(id))}
            >
              <HiOutlineMinus />
            </button>
          </div>
